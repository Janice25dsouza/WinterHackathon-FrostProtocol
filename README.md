...
1. Clone the repository - git clone https://github.com/Janice25dsouza/WinterHackathon-FrostProtocol.git
2. npm install
3. npx hardhat node (terminal 1)
4. npx hardhat clean (terminal 2)
5. npx hardhat compile
6. npx hardhat run backend/scripts/deploy.js --network localhost
7. cd frontend1
8. npm start
